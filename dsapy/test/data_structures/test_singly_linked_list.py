import unittest
from dsapy.src.data_structures.singly_linked_list import SinglyLinkedList
...
class TestSinglyLinkedList(unittest.TestCase):
    ...
    def test_copy(self):
        ...
        with self.subTest('Deep Copy'):
            ll = SinglyLinkedList([[1, 2, 3, 4], [1, 2, 3, 4]])
            new_ll = ll.copy()
    ...
    def test_search(self):
        ...
        with self.subTest('Multiple Item Encounter'):
            ll = SinglyLinkedList(['a', 'b', 'z', 'c', 'd', 'z', 'z', 'z', 'e'])
    ...
    def test_initialization(self):
        with self.subTest('Initialize Empty Linked List'):
            ...
            self.assertEqual('HEAD->NONE', ll.to_string())
            self.assertEqual([], ll.to_list())
        ...
        with self.subTest('Initialize from a list'):
            ...
            self.assertEqual('HEAD->[a]->[b]->[c]->[d]->NONE', ll.to_string())
